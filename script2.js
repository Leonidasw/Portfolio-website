/*fetch('https://api.ipify.org?format=json')
  ...
  .then(data => {
    ...
    document.getElementById('framep1').innerHTML = 'Ip: '+ ipAddress;
  })
  .catch(error => {
    console.error('Error:', error);
    alert('Failed to retrieve your IP address.');
  });
...
document.getElementById('framep2').innerHTML = '\n'+userRegion + "\n" + userCountry + "\n" + userTimeZone + "\n" + userCity 
...
fetch('https://api.ipify.org?format=json')
  ...
  .then(data => {
    ...
    // Get user's country and city based on their IP address
    fetch(`https://ipapi.co/${ipAddress}/json/`)
      ...
      .then(locationData => {
        ...
        document.getElementById('framep2').innerHTML = 'IP Address: '+ipAddress +'\n'+', Timezone: '+timezone+'\n'+', Country: '+ country+ '\n' + ', City: '+city;

      })
      .catch(error => {
        console.error('Error:', error);
        alert('Failed to retrieve country and city information.');
      });
  })
  .catch(error => {
    console.error('Error:', error);
    alert('Failed to retrieve IP address and timezone information.');
  });
 Ignorez ce code c'était un test d'adresse Ip */
